...
export default auth((req) => {
    ...
    //   if (nextUrl.pathname === DEFAULT_LOGIN_REDIRECT || nextUrl.pathname === "/auth/register" || nextUrl.pathname === "/auth/error" || nextUrl.pathname === "/dashboard") {
    ...
    //   if (nextUrl.pathname === "/auth/login" || nextUrl.pathname === "/auth/register" || nextUrl.pathname === "/auth/error" || nextUrl.pathname === "/dashboard") {
